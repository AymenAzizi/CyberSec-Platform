...
@section('title', $pageTitle ?? 'Set new password · CyberSec Platform')
    ...
    <form method="POST" action="{{ route('password.update') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="password" type="password" name="password"
                   ...
                   placeholder="At least 12 characters, mixed case + digits + symbols" required autocomplete="new-password">
