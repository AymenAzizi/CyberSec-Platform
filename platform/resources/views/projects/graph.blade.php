@extends('layouts.app', ['unacknowledgedAlerts' => 0])
...
<div class="space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-400">{{ $project->name }} — {{ $project->assets->count() }} assets · {{ $project->assets->load('sourceRelations')->pluck('sourceRelations')->flatten()->count() }} relations</p>
        </div>
        <div class="flex items-center gap-2">
            <a href="{{ route('projects.show', $project) }}#graph" class="btn-outline">
