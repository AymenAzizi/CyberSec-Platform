...
\markboth{Annexe A : Sp\'ecifications de l'API RESTful}{Annexe A : Sp\'ecifications de l'API RESTful}
...
\hline
\texttt{/api/v1/scans} & POST & \texttt{project\_id}, \texttt{type}, \texttt{profile} & Enfilement asynchrone Redis Streams d'un scan & 202 \\
\hline
