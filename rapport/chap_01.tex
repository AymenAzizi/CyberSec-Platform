...
\par Pour r\'epondre \`a cette probl\'ematique, nous proposons la r\'ealisation d'une \textbf{plateforme web semi-agentique de reconnaissance de surface d'attaque}. La solution s'appuie sur une architecture en microservices d\'ecoupl\'ee associant :
\begin{itemize}
    \item Un portail web applicatif d\'evelopp\'e avec \textbf{Laravel 11} assurant l'authentification s\'ecuris\'ee, le contr\^ole d'acc\`es RBAC granulaire, la gestion des projets et le rendu ergonomique.
