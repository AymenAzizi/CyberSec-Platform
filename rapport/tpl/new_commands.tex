...
%================== code listings (for implementation chapter) ===================%
\usepackage{listings}
\usepackage{xcolor}
...
\lstdefinestyle{python}{style=plaincode, language=Python}
\lstdefinestyle{bash}{style=plaincode, language=bash}
\lstdefinestyle{yaml}{style=plaincode, language={}}
\lstdefinestyle{dockerfile}{style=plaincode, language={}}
\lstdefinestyle{json}{style=plaincode, language={}}
\lstdefinestyle{php}{style=plaincode, language=PHP}
\lstdefinestyle{js}{style=plaincode, language=Java}
\lstdefinestyle{ansible}{style=plaincode, language={}}
\lstdefinestyle{sql}{style=plaincode, language=SQL}

\lstset{style=plaincode}

%================== TikZ libraries (for new diagrams) ===================%
