...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        <x-kpi-card icon="priority_high"     label="Critical Findings"        :value="$kpis['critical']"          color="red"    href="{{ route('reports.index') }}?severity=critical" />
        <x-kpi-card icon="warning"           label="High Findings"            :value="$kpis['high']"              color="orange" href="{{ route('reports.index') }}?severity=high" />
        ...
        <x-kpi-card icon="summarize"         label="Total Findings"           :value="$kpis['total_findings']"    color="violet" href="{{ route('reports.index') }}" />
    </div>
