...
class ChatSessionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $firstProject = Project::where('user_id', $analyst->id)->first();

        $this->seedCriticalTriageChat($analyst, $firstProject);
        $this->seedRemediationWalkthroughChat($analyst, $firstProject);
    }
